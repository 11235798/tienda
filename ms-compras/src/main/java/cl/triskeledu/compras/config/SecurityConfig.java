 ...
 * │ /api/v1/detalles/**                │ GET    │ ADMIN, USER                                    │
 * │ /api/v1/detalles/**                │ POST   │ ADMIN                                          │
 * │ /api/v1/detalles/**                │ PUT    │ ADMIN                                          │
 * │ /api/v1/detalles/**                │ DELETE │ ADMIN                                          │
 * │ /api/v1/videojuegos-proyeccion/**  │ GET    │ ADMIN, USER                                    │
 * │ /api/v1/clientes-proyeccion/**     │ GET    │ ADMIN, USER                                    │
